...
const API_END_POINTS = {
  ...
  CREATE_DEPARTMENT: '/apis/protected/v8/portal/cbc/department',
  UPDATE_DEPARTMENT: '/apis/protected/v8/portal/cbc/department',
  ASSIGN_ADMIN_TO_CREATED_DEPARTMENT: '/apis/protected/v8/portal/cbc/deptAction/',
